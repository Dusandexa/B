      ...
      <div class="container hero-container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
          <ul class="navbar-nav align-items-lg-center me-lg-3">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/srb/nas-tim" id="teamDropdown" role="button" data-bs-toggle="dropdown">Naš Tim</a>
          ...
          <div class="lang-switcher">
            ...
            <div class="lang-dropdown">
              ...
              <a href="/srb/kontakt" class="lang-option active"><img src="https://flagcdn.com/w40/rs.png" alt="Serbian" class="lang-flag" />Srpski</a>
            </div>
          </div>
        </div>
      </div>
