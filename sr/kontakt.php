    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom py-3">
      <div class="container hero-container">
        <a class="navbar-brand d-flex flex-column pl-20" href="/sr/">
          <span>BnB LAW</span>
          <small class="navbar-brand-subtext">Bojan Vučković & Bojana Miljanović</small>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
          <ul class="navbar-nav align-items-lg-center me-lg-3">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/sr/pravne-oblasti" id="moreLinksDropdown" role="button" data-bs-toggle="dropdown">Pravne Oblasti</a>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/sr/nas-tim" id="teamDropdown" role="button" data-bs-toggle="dropdown">Naš Tim</a>
            ...
            <li class="nav-item"><a class="nav-link active" href="/sr/kontakt">Kontaktirajte nas</a></li>
          </ul>
          ...
          <div class="lang-switcher">
            ...
            <div class="lang-dropdown">
              <a href="/contact" class="lang-option"><img src="https://flagcdn.com/w40/gb.png" alt="English" class="lang-flag" />English</a>
              <a href="/sr/kontakt" class="lang-option active"><img src="https://flagcdn.com/w40/rs.png" alt="Serbian" class="lang-flag" />Srpski</a>
            </div>
          </div>
        </div>
      </div>
